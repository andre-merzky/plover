...
silent only
cd ~/saga/simple/saga/util
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +217 shared_ptr.hpp
badd +8 test_shared_ptr.cpp
badd +52 mutex.hpp
badd +144 shared_counter.hpp
badd +0 scoped_lock.hpp
args shared_ptr.hpp
edit shared_ptr.hpp
...
silent! normal! zE
let s:l = 270 - ((25 * winheight(0) + 25) / 50)
