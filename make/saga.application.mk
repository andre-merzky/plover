...
ifdef SAGA_USE_BOOST_TEST
  SAGA_LDFLAGS += $(SAGA_BOOST_TEST_LDFLAGS)
endif

ifdef SAGA_USE_READLINE
  SAGA_LDFLAGS += $(SAGA_LDFLAGS_READLINE)
endif

ifdef SAGA_USE_BOOST_OPTIONS
  SAGA_LDFLAGS += $(SAGA_BOOST_OPTIONS_LDFLAGS)
endif
...
ifdef SAGA_ROOT
  SAGA_TMP_MINCS += $(wildcard $(SAGA_MAKE_INCLUDE_ROOT)/saga.engine.i.mk)
  SAGA_TMP_MINCS += $(wildcard $(SAGA_MAKE_INCLUDE_ROOT)/saga.package.*.i.mk)
else
  SAGA_TMP_MINCS += $(wildcard $(SAGA_MAKE_INCLUDE_ROOT)/saga.engine.mk)
